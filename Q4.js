...
//Q3
const sortedGods = gods.sort((a, b) => a.pantheon.localeCompare(b.pantheon));
console.log(sortedGods);

//Q4
const godNamesWithClass = gods.map(god => `${god.name} (${god.class})`);
console.log(godNamesWithClass);
